...
cyl4:translate(50,0.0,-300)
cyl5:set_material(hide)
scene:add_child(cyl5)
cyl5:translate(-10,0.0,-400)
...
icosa2:translate(-20,0.0, 200.0)
icosa3:set_material(hide)
scene:add_child(icosa3)
icosa3:translate(-10,0.0, -200.0)
...
dodeca3:set_material(stone)
scene:add_child(dodeca3)
dodeca3:translate(300,0.0,-350)
