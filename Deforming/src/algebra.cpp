...
Matrix4x4 Vector4D::getRotMatrix(){
    Matrix4x4 result;
    result[0][0] = 1.0 - 2.0 * v_[2] * v_[2] - 2.0 * v_[3] * v_[3];
    result[0][1] = 2.0 * v_[1] * v_[2] - 2.0 * v_[0] * v_[3];
    result[0][2] = 2.0 * v_[1] * v_[3] + 2.0 * v_[0] * v_[2];

    result[1][0] = 2.0 * v_[1] * v_[2] + 2.0 * v_[0] * v_[3];
    result[1][1] = 1.0 - 2.0 * v_[1] * v_[1] - 2.0 * v_[3] * v_[3];
    result[1][2] = 2.0 * v_[2] * v_[3] - 2.0 * v_[0] * v_[1];

    result[2][0] = 2.0 * v_[1] * v_[3] - 2.0 * v_[0] * v_[2];
    result[2][1] = 2.0 * v_[2] * v_[3] + 2.0 * v_[0] * v_[1];
    result[2][2] = 1.0 - 2.0 * v_[1] * v_[1] - 2.0 * v_[2] * v_[2];
